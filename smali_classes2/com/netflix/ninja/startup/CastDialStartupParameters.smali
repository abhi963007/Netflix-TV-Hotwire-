.class public Lcom/netflix/ninja/startup/CastDialStartupParameters;
.super Lcom/netflix/ninja/startup/BaseStartupParameters;
.source "CastDialStartupParameters.java"


# static fields
.field private static final TAG:Ljava/lang/String; = "nf-startup-cast"


# instance fields
.field private mOwner:Lcom/netflix/ninja/MainActivity;

.field private mReceivedIntent:Landroid/content/Intent;
...
.method static createStartupParameters(Landroid/content/Intent;Lcom/netflix/ninja/MainActivity;)Lcom/netflix/ninja/startup/StartupParameters;
    .locals 2
    ...
    invoke-static {v0}, Lcom/netflix/ninja/startup/CastDialStartupParameters;->isCorrectCastStartTarget(Landroid/net/Uri;)Z
    ...
    .line 47
    :cond_0
    new-instance v1, Lcom/netflix/ninja/startup/CastDialStartupParameters;

    invoke-direct {v1}, Lcom/netflix/ninja/startup/CastDialStartupParameters;-><init>()V

    .line 48
    iput-object p1, v1, Lcom/netflix/ninja/startup/CastDialStartupParameters;->mOwner:Lcom/netflix/ninja/MainActivity;

    .line 49
    iput-object p0, v1, Lcom/netflix/ninja/startup/CastDialStartupParameters;->mReceivedIntent:Landroid/content/Intent;

    const-string p0, "dial"

    .line 50
    invoke-virtual {v1, p0, v0}, Lcom/netflix/ninja/startup/CastDialStartupParameters;->addParameter(Ljava/lang/String;Ljava/lang/String;)V
...
.method public forward()Z
    ...
    .line 28
    iget-object v0, p0, Lcom/netflix/ninja/startup/CastDialStartupParameters;->mOwner:Lcom/netflix/ninja/MainActivity;

    iget-object v1, p0, Lcom/netflix/ninja/startup/CastDialStartupParameters;->mReceivedIntent:Landroid/content/Intent;

    invoke-virtual {v0, v1}, Lcom/netflix/ninja/MainActivity;->reportDialConnection(Landroid/content/Intent;)V
