...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nDETBroadcastReceiver.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DETBroadcastReceiver.kt\ncom/netflix/ninja/DETBroadcastReceiver\n+ 2 Data.kt\nandroidx/work/DataKt\n+ 3 OneTimeWorkRequest.kt\nandroidx/work/OneTimeWorkRequestKt\n*L\n1#1,160:1\n31#2,5:161\n29#3:166\n*E\n*S KotlinDebug\n*F\n+ 1 DETBroadcastReceiver.kt\ncom/netflix/ninja/DETBroadcastReceiver\n*L\n84#1,5:161\n129#1:166\n*E\n"
.end annotation
...
# static fields
.field public static final Companion:Lcom/netflix/ninja/DETBroadcastReceiver$Companion;

.field public static final EXTRA_DEBUG_OPTIONS:Ljava/lang/String; = "debugOptions"

.field public static final EXTRA_GRAPHQL_PAYLOAD:Ljava/lang/String; = "graphQLPayload"

.field public static final EXTRA_QUERY_COMMAND:Ljava/lang/String; = "queryCommand"

.field public static final EXTRA_QUERY_LANGUAGE:Ljava/lang/String; = "language"

.field public static final EXTRA_QUERY_OPTIONS:Ljava/lang/String; = "queryOptions"

.field public static final EXTRA_QUERY_PARTNER_ID:Ljava/lang/String; = "partnerID"

.field public static final EXTRA_QUERY_PARTNER_PAI:Ljava/lang/String; = "partnerPAI"

.field public static final EXTRA_QUERY_VERSION:Ljava/lang/String; = "version"

.field private static final INTENT_DET_REQUEST:Ljava/lang/String; = "com.netflix.ninja.intent.action.DET_REQUEST"

.field private static final INTENT_DET_TOKEN_REQUEST:Ljava/lang/String; = "com.netflix.ninja.intent.action.DET_TOKEN_REQUEST"

.field private static final MAX_CONCURRENT_WORK:I = 0x5

.field public static final TAG:Ljava/lang/String; = "nf_det_receiver"
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/netflix/ninja/DETBroadcastReceiver$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/netflix/ninja/DETBroadcastReceiver$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lcom/netflix/ninja/DETBroadcastReceiver;->Companion:Lcom/netflix/ninja/DETBroadcastReceiver$Companion;
...
.method private final handleDETTokenRequest(Landroid/content/Context;)V
    .locals 2
    ...
    invoke-virtual {v1, p1, v0}, Lcom/netflix/mediaclient/util/ServiceUtils$Companion;->tryStartServiceIfWhitelisted(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {v1}, Lcom/netflix/mediaclient/service/preapp/DETAuthManager$DETToken;->getId()Ljava/lang/String;
...
# virtual methods
.method protected final handleDETRequest(Landroid/content/Context;Landroid/content/Intent;Z)V
    .locals 18
    ...
    .line 78
    new-instance v15, Landroidx/work/Constraints$Builder;

    invoke-direct {v15}, Landroidx/work/Constraints$Builder;-><init>()V

    .line 79
    sget-object v0, Landroidx/work/NetworkType;->CONNECTED:Landroidx/work/NetworkType;

    invoke-virtual {v15, v0}, Landroidx/work/Constraints$Builder;->setRequiredNetworkType(Landroidx/work/NetworkType;)Landroidx/work/Constraints$Builder;
    ...
    .line 80
    invoke-virtual {v0, v15}, Landroidx/work/Constraints$Builder;->setRequiresCharging(Z)Landroidx/work/Constraints$Builder;
    ...
    invoke-virtual {v1, v9, v8}, Landroidx/work/Data$Builder;->put(Ljava/lang/String;Ljava/lang/Object;)Landroidx/work/Data$Builder;
    ...
    invoke-virtual {v1, v9}, Landroidx/work/WorkManager;->getWorkInfosByTag(Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    const-string/jumbo v11, "workInfo"

    .line 104
    invoke-static {v10, v11}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v10}, Landroidx/work/WorkInfo;->getState()Landroidx/work/WorkInfo$State;

    move-result-object v10

    const-string/jumbo v11, "workInfo.state"
    ...
    invoke-virtual {v5, v7}, Landroidx/work/WorkManager;->cancelAllWorkByTag(Ljava/lang/String;)Landroidx/work/Operation;
    ...
    .line 130
    invoke-virtual {v6, v7}, Landroidx/work/OneTimeWorkRequest$Builder;->setConstraints(Landroidx/work/Constraints;)Landroidx/work/WorkRequest$Builder;
    ...
    .line 131
    invoke-virtual {v6, v5}, Landroidx/work/OneTimeWorkRequest$Builder;->addTag(Ljava/lang/String;)Landroidx/work/WorkRequest$Builder;
    ...
    invoke-virtual {v5, v6, v7, v9}, Landroidx/work/OneTimeWorkRequest$Builder;->setInitialDelay(JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    ...
    .line 133
    invoke-virtual {v5, v0}, Landroidx/work/OneTimeWorkRequest$Builder;->setInputData(Landroidx/work/Data;)Landroidx/work/WorkRequest$Builder;
    ...
    invoke-virtual {v1, v5}, Landroidx/work/WorkManager;->enqueue(Landroidx/work/WorkRequest;)Landroidx/work/Operation;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    sget-object v0, Lcom/netflix/ninja/featureconfig/ARConfig;->INSTANCE:Lcom/netflix/ninja/featureconfig/ARConfig;

    invoke-virtual {v0, p1}, Lcom/netflix/ninja/featureconfig/ARConfig;->isARModeEnabled(Landroid/content/Context;)Z
    ...
    .line 59
    invoke-virtual {p0, p1, p2, v0}, Lcom/netflix/ninja/DETBroadcastReceiver;->handleDETRequest(Landroid/content/Context;Landroid/content/Intent;Z)V
    ...
    .line 62
    invoke-direct {p0, p1}, Lcom/netflix/ninja/DETBroadcastReceiver;->handleDETTokenRequest(Landroid/content/Context;)V
