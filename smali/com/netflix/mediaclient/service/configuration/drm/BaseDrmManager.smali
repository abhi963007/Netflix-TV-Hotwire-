...
.method public constructor <init>(Landroid/content/Context;Lcom/netflix/mediaclient/service/logging/ErrorLogging;Lcom/netflix/mediaclient/service/configuration/drm/DrmManager$DrmReadyCallback;)V
    ...
    invoke-static {p1, p3, p2}, Lcom/netflix/mediaclient/util/PreferenceUtils;->putStringPref(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
...
.method private getCryptoSessionWithDrmSession(J)Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;
    ...
    invoke-static {p2, v0}, Lcom/netflix/mediaclient/util/MediaDrmUtils;->openDrmSession(Landroid/media/MediaDrm;Ljava/lang/String;)[B
    ...
    .line 1255
    invoke-static {p2}, Lcom/netflix/mediaclient/Log;->logDeviceWarn(Ljava/lang/Throwable;)V
...
.method private getErrorString(Lcom/netflix/mediaclient/StatusCode;)Ljava/lang/String;
    ...
    .line 1131
    sget-object p1, Lcom/netflix/mediaclient/StatusCode;->UNKNOWN:Lcom/netflix/mediaclient/StatusCode;
...
.method private pruneCryptoSessionIfNeeded()V
    ...
    const-string/jumbo v6, "without key, "
...
.method private reportError(Lcom/netflix/mediaclient/StatusCode;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1}, Lcom/netflix/mediaclient/Log;->logDeviceError(Ljava/lang/String;)V
...
.method protected closeCryptoSession(Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;)Z
    ...
    const-string v3, "closeCryptoSession "
    ...
    const-string v3, "MSL:closeCryptoSession"

    invoke-static {v1, v2, v3}, Lcom/netflix/mediaclient/util/MediaDrmUtils;->closeDrmSession(Landroid/media/MediaDrm;[BLjava/lang/String;)V
...
.method protected declared-synchronized closeSessionAndRemoveKeys(Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public decrypt(J[B[B)[B
    ...
    .line 416
    sget-object p2, Lcom/netflix/mediaclient/StatusCode;->DRM_FAILURE_MEDIADRM_RESET:Lcom/netflix/mediaclient/StatusCode;
...
.method protected doDecrypt(Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;[B[BZ)[B
    ...
    .line 442
    invoke-static {v5, v6}, Lcom/netflix/mediaclient/util/CryptoUtils;->unpadPerPKCS5Padding([BI)[B
    ...
    invoke-static {v5, v4, v6}, Lcom/netflix/mediaclient/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method protected doEncrypt(Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;[B[BZ)[B
    ...
    .line 507
    invoke-static {v3, v9}, Lcom/netflix/mediaclient/util/CryptoUtils;->padPerPKCS5Padding([BI)[B
    ...
    invoke-static {v12, v13}, Lcom/netflix/mediaclient/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v9, v5}, Lcom/netflix/mediaclient/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 532
    invoke-static {v5, v9}, Lcom/netflix/mediaclient/util/CryptoUtils;->padPerPKCS5Padding([BI)[B
    ...
    invoke-static {v5, v9, v0}, Lcom/netflix/mediaclient/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-static {v0, v8, v5}, Lcom/netflix/mediaclient/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method protected declared-synchronized doGetNccpSessionKeyRequest(Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;Z)[B
    .locals 7
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {v1, v2, p1}, Lcom/netflix/mediaclient/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    if-eqz p2, :cond_1

    .line 768
    sget-object p2, Lcom/netflix/mediaclient/StatusCode;->DRM_FAILURE_MEDIADRM_GET_KEY_REQUEST:Lcom/netflix/mediaclient/StatusCode;
...
.method protected declared-synchronized doUpdateKeyResponseForNccpSession(Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;JJJ[B[B[BZ)Z
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    :goto_0
    invoke-static {p8}, Lcom/netflix/mediaclient/util/AssertUtils;->isTrue(Z)V
...
.method protected doVerify(Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;[B[BZ)Z
    ...
    const-string/jumbo p2, "verify - session NOT found!"
    ...
    const-string/jumbo p2, "verify - kch is null!"
    ...
    invoke-static {v5, v6, v4}, Lcom/netflix/mediaclient/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-static {v4, v6, v5}, Lcom/netflix/mediaclient/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method protected findMediaDrmCryptoSession(Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;)Landroid/media/MediaDrm$CryptoSession;
    ...
    .line 392
    sget-object v1, Lcom/netflix/mediaclient/StatusCode;->DRM_FAILURE_MEDIADRM_ILLEGAL_STATE:Lcom/netflix/mediaclient/StatusCode;
...
.method protected declared-synchronized getNccpSessionKeyRequest(J)[B
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method declared-synchronized getSessionIds()Lcom/netflix/mediaclient/service/configuration/drm/PersistedSessionsSnapshot;
    .locals 8
...
.method protected handleRecoverOnMediaDrmError(Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;)Z
    ...
    invoke-static {v1, v2}, Lcom/netflix/mediaclient/util/MediaDrmUtils;->createDrm(Ljava/util/UUID;Ljava/lang/String;)Landroid/media/MediaDrm;
    ...
    invoke-static {v1, v2}, Lcom/netflix/mediaclient/util/MediaDrmUtils;->openDrmSession(Landroid/media/MediaDrm;Ljava/lang/String;)[B
...
.method public synthetic lambda$mediaDrmFailure$1$BaseDrmManager()V
    ...
    invoke-static {v1, v0, v2}, Lcom/netflix/mediaclient/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method protected declared-synchronized mediaDrmFailure(Lcom/netflix/mediaclient/StatusCode;Ljava/lang/Throwable;)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method protected declared-synchronized mediaDrmFailure(Lcom/netflix/mediaclient/StatusCode;Ljava/lang/Throwable;Z)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 1152
    sget-object p2, Lcom/netflix/mediaclient/StatusCode;->DRM_FAILURE_MEDIADRM_WIDEVINE_PLUGIN_CHANGED:Lcom/netflix/mediaclient/StatusCode;
    ...
    .line 1156
    sget-object p1, Lcom/netflix/mediaclient/util/CoroutineUtils;->INSTANCE:Lcom/netflix/mediaclient/util/CoroutineUtils;
    ...
    invoke-virtual {p1, v0, v1, p2}, Lcom/netflix/mediaclient/util/CoroutineUtils;->launchDelayed(JLcom/netflix/mediaclient/util/LaunchFunction;)Lkotlinx/coroutines/Job;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {p2, v2}, Lcom/netflix/mediaclient/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1166
    sget-object p2, Lcom/netflix/mediaclient/util/CoroutineUtils;->INSTANCE:Lcom/netflix/mediaclient/util/CoroutineUtils;
    ...
    invoke-virtual {p2, v0, v1, v2}, Lcom/netflix/mediaclient/util/CoroutineUtils;->launchDelayed(JLcom/netflix/mediaclient/util/LaunchFunction;)Lkotlinx/coroutines/Job;
    ...
    .line 1184
    new-instance p3, Lcom/netflix/mediaclient/android/app/NetflixStatus;

    invoke-direct {p3, p1}, Lcom/netflix/mediaclient/android/app/NetflixStatus;-><init>(Lcom/netflix/mediaclient/StatusCode;)V

    const p1, 0x7f0f004b

    .line 1185
    invoke-virtual {p3, p1}, Lcom/netflix/mediaclient/android/app/NetflixStatus;->setMessageId(I)V
    ...
    invoke-virtual {p3}, Lcom/netflix/mediaclient/android/app/NetflixStatus;->getStatusCode()Lcom/netflix/mediaclient/StatusCode;
    ...
    .line 1189
    :cond_2
    invoke-virtual {p2, p3}, Lcom/netflix/ninja/NetflixService;->handleDrmError(Lcom/netflix/mediaclient/android/app/Status;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method declared-synchronized persistCryptoSessions([J)Z
    ...
    invoke-static {v0, v1, p1}, Lcom/netflix/mediaclient/Log;->logLongArray(Ljava/lang/String;Ljava/lang/String;[J)V
...
.method protected declared-synchronized removeCryptoSession(J)Z
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method protected declared-synchronized removeNotPersistedCryptoSessions()Z
    .locals 7
    ...
    invoke-static {v4, v2}, Lcom/netflix/mediaclient/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
...
.method protected restoreKeysToSession(Lcom/netflix/mediaclient/service/configuration/drm/CryptoSessionData;)Z
    ...
    invoke-static {v0, v1}, Lcom/netflix/mediaclient/util/MediaDrmUtils;->openDrmSession(Landroid/media/MediaDrm;Ljava/lang/String;)[B
...
.method protected declared-synchronized updateKeyResponseForNccpSession(JJJ[B[B[B)Z
    .locals 14
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
