...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    .line 51
    new-instance p1, Lcom/netflix/mediaclient/util/data/FileSystemDataRepositoryImpl;

    invoke-direct {p1, v1}, Lcom/netflix/mediaclient/util/data/FileSystemDataRepositoryImpl;-><init>(Ljava/io/File;)V

    iput-object p1, p0, Lcom/netflix/mediaclient/service/logging/LogblobRepository;->mDataRepository:Lcom/netflix/mediaclient/util/data/DataRepository;
...
.method static synthetic access$000(Lcom/netflix/mediaclient/service/logging/LogblobRepository;[Lcom/netflix/mediaclient/util/data/DataRepository$Entry;)V
    .locals 0

    .line 16
    invoke-direct {p0, p1}, Lcom/netflix/mediaclient/service/logging/LogblobRepository;->deliverSavedPayloads([Lcom/netflix/mediaclient/util/data/DataRepository$Entry;)V

    return-void
.end method

.method static synthetic access$100(Lcom/netflix/mediaclient/service/logging/LogblobRepository;)Lcom/netflix/mediaclient/util/data/DataRepository;
    .locals 0

    .line 16
    iget-object p0, p0, Lcom/netflix/mediaclient/service/logging/LogblobRepository;->mDataRepository:Lcom/netflix/mediaclient/util/data/DataRepository;
...
.method private deliverSavedPayloads([Lcom/netflix/mediaclient/util/data/DataRepository$Entry;)V
    ...
    .line 103
    iget-object v3, p0, Lcom/netflix/mediaclient/service/logging/LogblobRepository;->mDataRepository:Lcom/netflix/mediaclient/util/data/DataRepository;
    ...
    invoke-interface {v3, v2, v4}, Lcom/netflix/mediaclient/util/data/DataRepository;->load(Ljava/lang/String;Lcom/netflix/mediaclient/util/data/DataRepository$DataLoadedCallback;)V
...
.method private doRemoveSavedLogblobs(Ljava/lang/String;)V
    ...
    .line 172
    :try_start_0
    iget-object v1, p0, Lcom/netflix/mediaclient/service/logging/LogblobRepository;->mDataRepository:Lcom/netflix/mediaclient/util/data/DataRepository;

    invoke-interface {v1, p1}, Lcom/netflix/mediaclient/util/data/DataRepository;->remove(Ljava/lang/String;)V
...
.method private loadAndSendLogblobs(Ljava/lang/String;)V
    ...
    .line 132
    :cond_0
    iget-object v0, p0, Lcom/netflix/mediaclient/service/logging/LogblobRepository;->mDataRepository:Lcom/netflix/mediaclient/util/data/DataRepository;
...
# virtual methods
.method public declared-synchronized loadNotDeliveredEvents()V
    .locals 2
...
.method public declared-synchronized saveToDisk(Ljava/lang/String;)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-interface {v0, v1, p1}, Lcom/netflix/mediaclient/util/data/DataRepository;->save(Ljava/lang/String;[B)Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
