...
.method private static configureErrorLogging(Landroid/content/Context;Lcom/netflix/mediaclient/service/webclient/model/leafs/ErrorLoggingSpecification;)V
    ...
    invoke-virtual {p1}, Lcom/netflix/mediaclient/service/webclient/model/leafs/ErrorLoggingSpecification;->isDisableBugSnag()Z
    ...
    invoke-static {p0, v1}, Lcom/netflix/mediaclient/util/DeviceUtils;->isDeviceEnabled(Landroid/content/Context;I)Z
    ...
    .line 84
    invoke-virtual {p1}, Lcom/netflix/mediaclient/service/webclient/model/leafs/ErrorLoggingSpecification;->getDisableHandledChancePercentage()I

    move-result p1

    invoke-static {p0, p1}, Lcom/netflix/mediaclient/util/DeviceUtils;->isDeviceEnabled(Landroid/content/Context;I)Z
    ...
    .line 85
    invoke-static {v0, p0, p1}, Lcom/netflix/mediaclient/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method private static declared-synchronized initCrashReporters(Landroid/content/Context;Lcom/netflix/mediaclient/service/webclient/model/leafs/ErrorLoggingSpecification;)V
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-interface {v2, p0, p1}, Lcom/netflix/mediaclient/service/logging/error/ExternalCrashReporter;->setEnabled(Landroid/content/Context;Lcom/netflix/mediaclient/service/webclient/model/leafs/ErrorLoggingSpecification;)Z
...
.method public static declared-synchronized onConfigurationChanged(Landroid/content/Context;JLcom/netflix/mediaclient/service/webclient/model/leafs/ErrorLoggingSpecification;)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 111
    invoke-static {p0, p3}, Lcom/netflix/mediaclient/service/logging/error/ErrorLoggingManager;->initCrashReporters(Landroid/content/Context;Lcom/netflix/mediaclient/service/webclient/model/leafs/ErrorLoggingSpecification;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
