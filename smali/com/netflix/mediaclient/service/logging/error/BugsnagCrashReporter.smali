...
.method public logHandledException(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/bugsnag/android/Bugsnag;->notify(Ljava/lang/Throwable;)V
...
.method public setEnabled(Landroid/content/Context;Lcom/netflix/mediaclient/service/webclient/model/leafs/ErrorLoggingSpecification;)Z
    .locals 6
    ...
    .line 33
    invoke-virtual {p2}, Lcom/netflix/mediaclient/service/webclient/model/leafs/ErrorLoggingSpecification;->isDisableBugSnag()Z
    ...
    invoke-virtual {v1, v3}, Lcom/bugsnag/android/Configuration;->setProjectPackages(Ljava/util/Set;)V
    ...
    invoke-virtual {v1, v0}, Lcom/bugsnag/android/Configuration;->setEnabledBreadcrumbTypes(Ljava/util/Set;)V

    const/16 v0, 0x64

    .line 41
    invoke-virtual {v1, v0}, Lcom/bugsnag/android/Configuration;->setMaxBreadcrumbs(I)V
    ...
    invoke-virtual {v1, v0}, Lcom/bugsnag/android/Configuration;->setProjectPackages(Ljava/util/Set;)V

    .line 45
    invoke-virtual {v1}, Lcom/bugsnag/android/Configuration;->getEnabledErrorTypes()Lcom/bugsnag/android/ErrorTypes;

    move-result-object v0

    invoke-virtual {v0, v5}, Lcom/bugsnag/android/ErrorTypes;->setAnrs(Z)V
    ...
    invoke-virtual {v0, v5}, Lcom/bugsnag/android/ErrorTypes;->setNdkCrashes(Z)V
    ...
    invoke-virtual {v0, v5}, Lcom/bugsnag/android/ErrorTypes;->setUnhandledRejections(Z)V

    .line 48
    move-object v0, p0

    check-cast v0, Lcom/bugsnag/android/Logger;

    invoke-virtual {v1, v0}, Lcom/bugsnag/android/Configuration;->setLogger(Lcom/bugsnag/android/Logger;)V
    ...
    check-cast v0, Lcom/bugsnag/android/OnErrorCallback;

    invoke-virtual {v1, v0}, Lcom/bugsnag/android/Configuration;->addOnError(Lcom/bugsnag/android/OnErrorCallback;)V

    .line 89
    invoke-static {p1, v1}, Lcom/bugsnag/android/Bugsnag;->start(Landroid/content/Context;Lcom/bugsnag/android/Configuration;)Lcom/bugsnag/android/Client;
