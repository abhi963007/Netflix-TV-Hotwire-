...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2, v2}, Lcom/netflix/mediaclient/media/AudioType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lcom/netflix/mediaclient/media/AudioType;->RESERVED:Lcom/netflix/mediaclient/media/AudioType;

    .line 11
    new-instance v1, Lcom/netflix/mediaclient/media/AudioType;

    const-string v3, "AAC_2"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v4}, Lcom/netflix/mediaclient/media/AudioType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/netflix/mediaclient/media/AudioType;->AAC_2:Lcom/netflix/mediaclient/media/AudioType;

    .line 12
    new-instance v3, Lcom/netflix/mediaclient/media/AudioType;

    const-string v5, "EAC3_2"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6, v6}, Lcom/netflix/mediaclient/media/AudioType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/netflix/mediaclient/media/AudioType;->EAC3_2:Lcom/netflix/mediaclient/media/AudioType;

    .line 13
    new-instance v5, Lcom/netflix/mediaclient/media/AudioType;

    const-string v7, "EAC3_5_1"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8, v8}, Lcom/netflix/mediaclient/media/AudioType;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/netflix/mediaclient/media/AudioType;->EAC3_5_1:Lcom/netflix/mediaclient/media/AudioType;

    .line 14
    new-instance v7, Lcom/netflix/mediaclient/media/AudioType;

    const-string v9, "DDPLUS_ATMOS"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10, v10}, Lcom/netflix/mediaclient/media/AudioType;-><init>(Ljava/lang/String;II)V

    sput-object v7, Lcom/netflix/mediaclient/media/AudioType;->DDPLUS_ATMOS:Lcom/netflix/mediaclient/media/AudioType;

    .line 15
    new-instance v9, Lcom/netflix/mediaclient/media/AudioType;

    const-string v11, "COUNT"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12, v12}, Lcom/netflix/mediaclient/media/AudioType;-><init>(Ljava/lang/String;II)V

    sput-object v9, Lcom/netflix/mediaclient/media/AudioType;->COUNT:Lcom/netflix/mediaclient/media/AudioType;

    const/4 v11, 0x6

    new-array v11, v11, [Lcom/netflix/mediaclient/media/AudioType;
    ...
    .line 9
    sput-object v11, Lcom/netflix/mediaclient/media/AudioType;->$VALUES:[Lcom/netflix/mediaclient/media/AudioType;
