...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v4, " getInputBuffer return null"
    ...
    invoke-virtual {v0, v8, v2, v3, v4}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderPipe2;->reportError(IILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_d
    const-string/jumbo v8, "videoCodecReady"
    ...
    invoke-virtual {v12}, Lcom/netflix/mediaclient/media/JPlayer/JPlayer2;->getStartLatencyLog()Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;

    move-result-object v12

    invoke-virtual {v12, v8}, Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;->recordTimer(Ljava/lang/String;)V
    ...
    invoke-static {v10, v7}, Lcom/netflix/mediaclient/util/ByteBufferUtils;->copyByteBuffer(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v0, v10}, Lcom/netflix/mediaclient/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v2}, Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;->recordTimer(Ljava/lang/String;)V
    ...
    const-string v0, "MediaDecoder2"

    const-string v2, "CryptoException ERROR_INSUFFICIENT_OUTPUT_PROTECTION. mHdcpErrorIngoreCnt: %d"

    new-array v3, v4, [Ljava/lang/Object;

    .line 652
    iget-object v5, v1, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderPipe2$1;->this$0:Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderPipe2;

    iget v5, v5, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderPipe2;->mHdcpErrorIngoreCnt:I
