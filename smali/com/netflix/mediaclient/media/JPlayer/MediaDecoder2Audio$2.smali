...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 257
    iget-object v12, v1, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio$2;->this$0:Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;

    iget-object v12, v12, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->mOutputBuffersQ:Ljava/util/LinkedList;
    ...
    iget-object v13, v13, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->mOutputBuffersQ:Ljava/util/LinkedList;
    ...
    invoke-virtual {v13}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->getDisplayModeSwitchPending()Z
    ...
    const-string v10, "Ingore renderer BUFFER_FLAG_END_OF_STREAM on "
    ...
    const-string v12, "AudioSwitch ptsOverlap: "

    invoke-virtual {v2, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v12, v1, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio$2;->this$0:Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;

    invoke-static {v12}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->access$1000(Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;)J
    ...
    const-string v12, "InsertSilenceFrame for PtsGap, gap: "
    ...
    const-string v2, ", mostRecentSamplePts: "
    ...
    invoke-static {v0, v2}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->access$1202(Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;I)I
    ...
    const-string v3, "Replace with muted package for PtsGap, ptsInMsThisFrame: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v8, v9}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v3, ", mostRecentSamplePts: "
    ...
    const-string v6, "AudioEaseOut for PtsGap. PTS: "
    ...
    invoke-static {v4, v0, v5}, Lcom/netflix/mediaclient/media/JPlayer/AudioEase;->fadeOneAudioFrame(Ljava/nio/ByteBuffer;Lcom/netflix/mediaclient/media/JPlayer/AudioEase$FadeType;I)Ljava/nio/ByteBuffer;
    ...
    const-string v6, "AudioEaseIn for PtsGap. PTS: "
    ...
    const-string v8, "Update EstimatedClock adjustedFirstPtsMs: "
    ...
    .line 464
    :try_start_f
    invoke-virtual {v0, v4}, Lcom/netflix/mediaclient/media/JPlayer/AudioEase;->easeStereo16pcm(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    move-result-object v0
    :try_end_f
    .catch Ljava/nio/BufferOverflowException; {:try_start_f .. :try_end_f} :catch_3
    ...
    invoke-virtual {v0, v5}, Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;->recordTimer(Ljava/lang/String;)V
    ...
    invoke-static {v0, v4, v5, v6, v7}, Lcom/netflix/mediaclient/media/JPlayer/JPlayer2Helper;->writeHwAvSyncAudioTrack(Landroid/media/AudioTrack;Ljava/nio/ByteBuffer;IJ)I
    ...
    invoke-virtual {v0, v4, v5, v6}, Landroid/media/AudioTrack;->write(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-static {v4}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->access$900(Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;)J
    ...
    invoke-static {v4, v2, v3}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->access$902(Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;J)J
    ...
    invoke-static {v6}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->access$900(Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;)J
    ...
    invoke-static {v4}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->access$500(Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;)Landroid/media/AudioTrack;
    ...
    iget-wide v4, v0, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->mOutputPackageCnt:J

    add-long v4, v4, v20

    iput-wide v4, v0, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->mOutputPackageCnt:J
    ...
    invoke-static {v4}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->access$2100(Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;)I
    ...
    invoke-virtual {v0, v2, v3, v4, v5}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$Clock;->updateMostRecentPtsAndAddSampleCnt(JJ)V
    ...
    invoke-virtual {v0, v2, v3, v4}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->updatePtsIfNeeded(JZ)V
    ...
    const-string v5, "MediaDecoder2AudioAudioTrack.write() return unhandled code "
    ...
    invoke-virtual {v2, v4, v3, v0, v5}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->reportError(IILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v4, "AudioTrack.write() returns "
    ...
    const-string v4, "AuioTrack is no ready "
    ...
    invoke-static {v0, v2}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->access$502(Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;Landroid/media/AudioTrack;)Landroid/media/AudioTrack;
    ...
    iget-object v3, v0, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2Audio;->mOutputBuffersQ:Ljava/util/LinkedList;

    monitor-enter v3
    :try_end_13
    .catch Ljava/util/NoSuchElementException; {:try_start_13 .. :try_end_13} :catch_5
    ...
    throw v0
    :try_end_15
    .catch Ljava/util/NoSuchElementException; {:try_start_15 .. :try_end_15} :catch_5

    :catch_5
    const-string v0, "MediaDecoder2Audio"

    const-string v3, "Try to removeFirst when mOutputBuffersQ.size is %d"
    ...
    invoke-static {v0, v3, v5}, Lcom/netflix/mediaclient/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    const-string v3, "render state is not play"
