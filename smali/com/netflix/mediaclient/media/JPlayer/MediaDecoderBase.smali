...
.method public clearDisplayModeSwitchPending()V
    ...
    :cond_0
    const-string/jumbo v0, "video gets display mode switching complete"
...
.method public declared-synchronized clearRenderStartPts()V
    .locals 2
...
.method public setDisplayModeSwitchPending()V
    ...
    :cond_0
    const-string/jumbo v0, "video gets display mode switching pending"
...
.method protected updatePtsIfNeeded(JZJ)V
    ...
    .line 128
    invoke-virtual {p3, p1, p2}, Lcom/netflix/ninja/NetflixService;->updateMediaSessionState(J)V
