...
.method constructor <init>(Lcom/netflix/mediaclient/media/JPlayer/JPlayer2;Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$InputDataSource;Lcom/netflix/mediaclient/media/AudioType;ILcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$EventListener;)V
    ...
    iput v1, p0, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2AudioPassthru;->mFrameDuration:I
    ...
    .line 141
    invoke-virtual {p1}, Lcom/netflix/mediaclient/service/configuration/ConfigurationAgent;->getReleaseAudioIfFails()Z
...
.method private createAttrAudioTrack(Z)Z
    ...
    invoke-virtual {p1, v2}, Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;->setAudioBufSize(Ljava/lang/Integer;)V
    ...
    iget v2, p0, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2AudioPassthru;->mChannelConfig:I
...
.method private fillCompressedAudioData(JI)V
    ...
    const-string v0, "fillCompressedAudioData, InsertSilenceFrame PTS "

    invoke-virtual {p3, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p3, p1, p2}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string p1, ", mTotalSilenceInserted "

    invoke-virtual {p3, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p1, p0, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2AudioPassthru;->mTotalSilenceInserted:I
    ...
    const-wide/16 p2, 0x600

    invoke-virtual {p1, v2, v3, p2, p3}, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$Clock;->updateMostRecentPtsAndAddSampleCnt(JJ)V
    ...
    invoke-static {v1, p1, p3}, Lcom/netflix/mediaclient/Log;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method private releaseAudioTrack()V
    ...
    .line 819
    iget-object v4, p0, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2AudioPassthru;->mClock:Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$Clock;
...
.method private startAudioTrack_internal()Z
    ...
    const-string/jumbo v2, "waiting for audiotrack buffer filled up ... "
    ...
    invoke-virtual {v3}, Lcom/netflix/mediaclient/media/JPlayer/JPlayer2;->getStartLatencyLog()Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;

    move-result-object v3

    const-string v4, "audioTrackStart"

    invoke-virtual {v3, v4}, Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;->recordTimer(Ljava/lang/String;)V
...
.method private updateEAC3DialNorm(Ljava/nio/ByteBuffer;Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$InputDataSource$BufferMeta;)V
    ...
    invoke-static {p2, v3, v1}, Lcom/netflix/mediaclient/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 233
    invoke-static {p1}, Lcom/netflix/mediaclient/util/ByteBufferUtils;->copyToByteArray(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {p2, v1, v0}, Lcom/netflix/mediaclient/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    invoke-static {p2, p1, v0}, Lcom/netflix/mediaclient/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method private updateRefClock(ZJJ)V
    ...
    invoke-static {v6, v12}, Lcom/netflix/mediaclient/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v4, v8, v9}, Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;->recordTimer(Ljava/lang/String;J)V
    ...
    invoke-virtual {v0, v4}, Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;->recordTimer(Ljava/lang/String;)V
...
.method public setVolumeShaper(Landroid/media/VolumeShaper$Configuration;)V
    ...
    .line 1094
    invoke-static {p1, v2}, Lcom/netflix/mediaclient/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
