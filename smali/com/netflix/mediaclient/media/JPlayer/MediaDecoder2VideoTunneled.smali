...
.method public constructor <init>(Lcom/netflix/mediaclient/media/JPlayer/JPlayer2;Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$InputDataSource;Ljava/lang/String;Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;FZZLcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$EventListener;)V
    ...
    .line 97
    invoke-virtual {p1}, Lcom/netflix/mediaclient/service/configuration/ConfigurationAgent;->isUpdateFirstPtsInTunnelMode()Z
    ...
    invoke-static {p4, p1}, Lcom/netflix/mediaclient/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {p1}, Lcom/netflix/mediaclient/media/JPlayer/JPlayer2;->getStartLatencyLog()Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;

    move-result-object p1

    const-string p3, "oldOSVersion"

    invoke-virtual {p1, p3}, Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;->disable(Ljava/lang/String;)V
    ...
    .line 135
    invoke-static {p4, p1}, Lcom/netflix/mediaclient/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
...
.method private configAndStartCodec(Z)V
    ...
    const-string v3, "configureDecoder "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p0, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2VideoTunneled;->mMediaFormat:Landroid/media/MediaFormat;
...
.method private prefetchForCodecConfig()V
    ...
    .line 218
    invoke-static {v3, v1, v0}, Lcom/netflix/mediaclient/Log;->logByteArrayRaw(Ljava/lang/String;Ljava/lang/String;[B)V
...
.method private queueInputbuffer(IZ)Ljava/lang/Boolean;
    ...
    iget v7, v11, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$InputDataSource$BufferMeta;->offset:I
    ...
    iget v7, v11, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$InputDataSource$BufferMeta;->size:I
    ...
    const-string v7, " ms flags "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v7, v11, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$InputDataSource$BufferMeta;->flags:I
    ...
    const-string v7, "STAT:DEC input late "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-wide v7, v1, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2VideoTunneled;->mFrameReceived:J
    ...
    iget-object v7, v1, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2VideoTunneled;->mRefClock:Lcom/netflix/mediaclient/media/JPlayer/MediaDecoderBase$Clock;
    ...
    sget-object v2, Lcom/netflix/ninja/featureconfig/VideoPeekConfig;->Companion:Lcom/netflix/ninja/featureconfig/VideoPeekConfig$Companion;

    invoke-virtual {v2}, Lcom/netflix/ninja/featureconfig/VideoPeekConfig$Companion;->isVideoPeekSupported()Z
    ...
    invoke-virtual {v2, v3}, Lcom/netflix/ninja/logblob/logs/PlayerStartLatencyLog;->recordTimer(Ljava/lang/String;)V
    ...
    const-string v3, "first PTS is "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-wide v3, v1, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2VideoTunneled;->mFirstInputPtsUs:J
    ...
    const-string v4, "CryptoException ERROR_INSUFFICIENT_OUTPUT_PROTECTION. mHdcpErrorIngoreCnt: %d"
    ...
    invoke-static {v0, v4, v3}, Lcom/netflix/mediaclient/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    const-string v4, "get exception as a result of getInputBuffer() "
...
.method public ignoreHdcpErrorWithinTime(I)V
    ...
    invoke-static {p1, v1, v0}, Lcom/netflix/mediaclient/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method public isUnderrun()Z
    ...
    iget-wide v4, p0, Lcom/netflix/mediaclient/media/JPlayer/MediaDecoder2VideoTunneled;->mLatestOutPtsMs:J
    ...
    const-string v1, "isUnderrun prevRenderTimeMs: %d, mPrevUpdatedPts: %d, mLatestOutPtsMs: %d, curMs: %d"

    invoke-static {v0, v1, v7}, Lcom/netflix/mediaclient/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
...
.method public renderFrame()V
    ...
    invoke-virtual {v0}, Lcom/netflix/ninja/platformsetting/PlatformCapabilitySetting$Companion;->getVideoPeekTunnelFramesToSend()I
...
.method public stop()V
    ...
    .line 712
    invoke-static {v0, v5, v4}, Lcom/netflix/mediaclient/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I

    .line 713
    invoke-static {v0, v3}, Lcom/netflix/mediaclient/Log;->printStackTrace(Ljava/lang/String;Ljava/lang/Throwable;)V
